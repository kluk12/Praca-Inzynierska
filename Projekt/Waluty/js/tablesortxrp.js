...
function orderbook() {
    ajaxGet('https://bittrex.com/api/v1.1/public/getorderbook?market=BTC-XRP&type=both', //
        function (response) {
...
function d() {
    ajaxGet('https://bittrex.com/api/v1.1/public/getmarketsummary?market=btc-XRP', //
        function (response) {
            response = JSON.parse(response);
            if (!response)
                return;
...
function ha() {
    ajaxGet('https://bittrex.com/api/v1.1/public/getmarkethistory?market=btc-XRP',
        function (response) {
            response = JSON.parse(response);
            if (!response)
                return;
